...
for o in range(1):
    ...
    plt.savefig('C:/Users/lim/Downloads//social_rspo2.pdf'.format(o), dpi=1200, format='pdf')
...
for o in range(1):
    for i in sig_cell_trace_list[o]:
        ...
        #
        #
        # # plt.savefig('J:\\Hansol_Yue\\experiment data\\figures\\'.str(i)'.pdf')
...
#%%
temp = [(np.mean(i<5),np.mean(i>20),np.mean((i>10)&(i<20))) for i in max_idx]
