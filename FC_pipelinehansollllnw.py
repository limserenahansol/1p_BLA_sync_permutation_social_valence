...
ca_tau = 2  # Replace with the real tau time of your calcium indicator
...
# folder_list = [
#     ('Etv1_1', 'FC_1', '1'), ('Etv1_2', 'FC_1', '1'),('Etv1_6', 'FC_1', '1'),
#     ('Etv1_8', 'FC_1', '2'), ('Etv1_9', 'FC_1', '2'), ('Etv1_15', 'FC_1', '1'), ('Etv1_16', 'FC_1', '1'),('Etv1_9', 'FC_1', '2'),
#     ('Etv1_17', 'FC_1', '1'), ('Etv1_18', 'FC_1', '1'), ('Etv1_19', 'FC_1', '3'), ('Lypd1_5', 'FC_1', '1'), ('Lypd1_11', 'FC_1', '2'), ('Lypd1_17', 'FC_1', '4')
#     # ('Rspo2_3','social_1','1'),
# ]
### ETV
folder_list = [
...
plt.subplot(2,2,3)
plt.imshow(sorted_freezing_PSTH[::-1,:], aspect='auto', cmap='binary')
